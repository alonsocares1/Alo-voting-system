...
const projectId = "2L5XDEdfMF4r6u7P5agslh1FY6h";
const projectSecretKey = "6fbe72e04791d66c1476f1accedf4211";
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain = "https://alonso-voting-app.infura-ipfs.io";
